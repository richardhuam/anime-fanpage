...
const classes = {
  root: 'font-medium inline-flex items-center justify-center flex-shrink-0 leading-none outline-none transition duration-300 ease-in-out focus:outline-none focus:shadow focus:ring-1 focus:ring-accent-primary/50',
  normal: 'bg-teal-600 hover:bg-teal-500 border-transparent text-white',
  outline:
    'border-teal-600 bg-transparent border text-teal-700 hover:text-teal-600 hover:border-teal-600',
  custom: 'border border-transparent',
  loading: 'h-4 w-4 ms-2 rounded-full border-2 border-transparent border-t-2 animate-spin',
  disabled: 'border border-teal-500 bg-teal-500 border-teal-500 text-gray-100 cursor-not-allowed',
